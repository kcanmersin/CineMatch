...
def recommend_for_user(user_ratings, all_movies, cosine_sim, ratings=None,  svd_model=None, top_n=10):
    ...
    if user_id in ratings['userId'].unique():
        ...
        return recommend_for_new_user_content_based(user_ratings, all_movies, cosine_sim, top_n=top_n)['id'].tolist()
...
def user_to_movie(user_ratings):
    ...
    # Get recommendations
    recommended_movies = recommend_for_user(user_ratings, movies, cosine_sim, ratings, svd_model)
